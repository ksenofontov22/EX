...
int HEIGHT_LCD{160}, WIDTH_LCD{256};
/* Analog-to-digital converter resolution (Chip PICO 2040). */
const int8_t RESOLUTION_ADC{12};
/* Port data. */
const int8_t PIN_STICK_0X = 4; // adc 0
const int8_t PIN_STICK_0Y = 0; // adc 1
const int8_t PIN_STICK_1Y = 2; // adc 2
const int8_t PIN_STICK_1X = 15; // adc 3

const int8_t PIN_BUTTON_STICK_0 = 36;  // gp 6
const int8_t PIN_BUTTON_STICK_1 = 39;  // gp 7
const int8_t PIN_BACKLIGHT_LCD = 34;   // gp 8
const int8_t PIN_BUZZER = 35;          // gp 9
